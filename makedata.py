...
adapted slightly by Patrick Moore for use in Blender addon
"""
...
def makeSphereCuboid():
    ...
    for i in range(Nz):
        ...
        im.save(fileName)  #this may crash blender!  http://blender.stackexchange.com/questions/27236/bpy-and-pil-pillow-crash
